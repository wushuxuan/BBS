<template>
	<div class="search">
		...
		<div class="tags">
			...
			<transition name="tagArea">
				<div class="tagArea" v-show="state=='on'">
					<div class="tag" v-for="tag in tags" :key="tag" v-show="tag" @click="getTagPsg(tag)">
						<span >{{tag}}</span>
					</div>
				</div>
			</transition>
		...
		<div class="result">
			...
			<div class="passage" v-for="(passage,index) in passages" :key="passage">
				<p>
				...
				<div class="tagType">
					...
					<div class="tag" v-for="tag in passage.tags" :key="tag" v-show="tag"  @click="getTagPsg(tag)">
						<span >{{tag}}</span>
					</div>
