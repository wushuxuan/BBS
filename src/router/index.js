...
const routes = [{
        path: '/',
        name: 'luntan',
        component: resolve => require(['../views/home/loginPage'], resolve),
    }, {
        path: '/register',
        name: 'register',
        component: resolve => require(['../views/home/registerPage'], resolve),
    }, {
        //主页入口
        path: '/home',
        name: 'home',
        ...
        children: [{ //我得
            ...
            { //wtalk
                path: '/wtalk',
                name: 'wtalk',
                component: resolve => require(['../views/wtalk/wtalk'], resolve)
            },
            //写帖子
            {
                path: 'new/articleId=:id',
                name: 'new',
                component: resolve => require(['../views/new/new'], resolve),
                props: true,
                meta: {
                    requireAuth: true,
                },
    ...
    //后台路由
    {
        ...
        children: [{
            ...
            },
            {
                ...
                path: 'messages',
                name: 'messages',
                component: resolve => require(['../views/admin/messages'], resolve),
                meta: {
                    requireAuth: true,
                },
            }, {
